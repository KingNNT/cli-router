...
- Entities (`UsageRecord`, `DailyUsage`, `Overview`, `DayModelRow`) are plain data. Value objects (`Cost`, `TokenCount`, `TokenBreakdown`, `DateRange`, `ModelId`, `ProjectPath`) enforce invariants via constructors.
